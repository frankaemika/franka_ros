...
bool TestJointTorqueLimitsController::init(hardware_interface::RobotHW* robot_hw, ros::NodeHandle &node_handle) {
...
void TestJointTorqueLimitsController::update(const ros::Time& time, const ros::Duration& period) {
...
PLUGINLIB_EXPORT_CLASS( test_franka_hw::TestJointTorqueLimitsController, controller_interface::ControllerBase)
